...
public class DateJava8 {
	...
	public static void main(String[] args) throws ParseException {
		//throws ParseException � uma declara��o de excess�o
		...
		//Obs.: Antes tava imprimindo no hor�rio de brasilia
		...
		//Para criar uma data, as 5am do dia 1 de janeiro de 1970. Que � a hora que o java guardou e come�ou a contar horas
		...
		//imprimiu as 2h porque � em rela��o ao GMT e eu estou no horario de brasilia, ent�o -3:00
