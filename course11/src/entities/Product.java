...
public class Product {
	...
	public void setPrice(double price) {
		this.price = price;
		//void porque ele não vai retornar e sim alterar.
	}
	public int getQuantity() {
		return quantity;
		/*Só vou criar o get porque ele só vai retornar, pois não faz sentido 
		 * alterar a quantidade do produto se não tiver nada em estoque, ou seja
